<footer id="footer" class="footer dark-background">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">Ponpes Assalam</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
...
<script src="{{ asset('build/assets/vendor/waypoints/noframework.waypoints.js') }}"></script>
